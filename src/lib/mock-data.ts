...
export const demoTeams: Team[] = [
  {
    ...
    paymentAmountArs: 120000,
    paymentPaidAt: "2026-06-01T12:00:00.000Z",
  ...
  ...Array.from({ length: 32 }, (_, index) => {
    ...
    return {
      ...
      mercadopagoPreferenceId: `demo-pref-${teamNumber}`,
      mercadopagoPaymentId: `demo-pay-${teamNumber}`,
      paymentAmountArs: 120000,
      paymentPaidAt: "2026-06-02T12:00:00.000Z",
      category: "Open",
