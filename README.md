...
- Mercado Pago Checkout Pro requires both `SUPABASE_SERVICE_ROLE_KEY` and the Mercado Pago server env vars to create preferences and process webhook updates safely.
